...
public class PizzaShop {
    ...
    public static PizzaCutter pizzaCutter= PizzaCutter.getInstance();
           ...
           //pizzaCutter;//we only ever want one 
   ...
   //and all pizzas must be cut by the same cutter.
    public static void main(String[] args) 
    {
        ...
        pizzaCutter.setNumSlices(sc.nextInt());
        
        if (pizza!=null)
        {
            System.out.println("Great job, here is your " + type + " pizza in " + pizzaCutter.getNumSlices() + " slices");
